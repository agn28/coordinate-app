          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(height: 40,),
                  Text(AppLocalizations.of(context).translate('waistMeasurement'), style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  SizedBox(height: 50,),
                  Row(
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: AppLocalizations.of(context).translate('waistOnly'),
