...
class ChwQuestionnairesScreen extends CupertinoPageRoute {
  ChwQuestionnairesScreen()
      : super(builder: (BuildContext context) => new ChwQuestionnaires());

}

class ChwQuestionnaires extends StatefulWidget {

  @override
  _ChwQuestionnairesState createState() => _ChwQuestionnairesState();
}

class _ChwQuestionnairesState extends State<ChwQuestionnaires> {
...
class EncounnterStepsChw extends StatefulWidget {
   EncounnterStepsChw({this.text, this.onTap, this.icon});
  ...
  @override
  EncounnterStepsChwState createState() => EncounnterStepsChwState();
}

class EncounnterStepsChwState extends State<EncounnterStepsChw> {
...
class _AddDialogueState extends State<AddDialogue> {
  ...
  _addItem() {
    ...
    EncounnterStepsChwState().initState();
  }
