...
class ChwCareplanDeliveryScreen extends StatefulWidget {
  var checkInState = false;
  static const String path = '/careplanDelivery';
  ChwCareplanDeliveryScreen({this.checkInState});
  @override
  _ChwCareplanDeliveryScreenState createState() => _ChwCareplanDeliveryScreenState();
}
