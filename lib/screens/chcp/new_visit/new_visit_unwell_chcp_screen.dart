...
class NewVisitUnwellChcpScreen extends StatefulWidget {
  static const path = '/newVisitUnWellChcpScreen';
  @override
  _NewVisitUnwellChcpScreen createState() => _NewVisitUnwellChcpScreen();
}

class _NewVisitUnwellChcpScreen extends State<NewVisitUnwellChcpScreen> {
