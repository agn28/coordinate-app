...
class ChcpUnwellCareplanScreen extends StatefulWidget {
  static const path = '/chcpUnwellCareplanScreen';
  @override
  _ChcpUnwellCareplanScreen createState() => _ChcpUnwellCareplanScreen();
}

class _ChcpUnwellCareplanScreen extends State<ChcpUnwellCareplanScreen> { 
  int _currentStep = 0;
            ...
            Expanded(
              child: _currentStep < _mySteps().length ? FlatButton(
                onPressed: () {
                  setState(() {
                    if (_currentStep == 0) {
                      Navigator.of(context).pushNamed(ChcpCareplanDeliveryScreen.path);
                    }
                  });
                },
