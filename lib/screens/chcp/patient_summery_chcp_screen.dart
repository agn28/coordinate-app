...
class PatientSummeryChcpScreen extends StatefulWidget {
  static const path = '/PatientSummeryChcp';
  var prevScreen = '';
  var encounterData = {};
  var checkInState = false;
  PatientSummeryChcpScreen({this.prevScreen, this.encounterData});
  @override
  _PatientSummeryChcpScreenState createState() => _PatientSummeryChcpScreenState();
}
