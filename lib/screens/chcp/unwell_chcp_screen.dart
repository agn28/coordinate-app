...
class UnwellChcpScreen extends StatefulWidget {
  static const path = '/unWellChcpScreen';
  @override
  _UnwellChcpScreen createState() => _UnwellChcpScreen();
}

class _UnwellChcpScreen extends State<UnwellChcpScreen> {
