...
class NewPatientQuestionnaireNurseScreen extends StatefulWidget {
  ...
  @override
  _NewPatientQuestionnaireNurseScreenState createState() =>
      _NewPatientQuestionnaireNurseScreenState();
}

class _NewPatientQuestionnaireNurseScreenState
    extends State<NewPatientQuestionnaireNurseScreen> {
  int _currentStep = 0;
  ...
  createObservations() {
    ...
    if (diastolicEditingController.text != '' &&
      ...
      BloodPressure().addItem(
          ...
          int.tryParse(pulseRateEditingController.text),
          null);
      var formData = {
