...
class NewQuestionnaireAcuteNurseScreen extends StatefulWidget {
  static const path = '/newQuestionnaireAcuteScreen';
  NewQuestionnaireAcuteNurseScreen({this.parent});
  final parent;

  @override
  _NewQuestionnaireAcuteNurseScreenState createState() => _NewQuestionnaireAcuteNurseScreenState();
}
...
class _NewQuestionnaireAcuteNurseScreenState extends State<NewQuestionnaireAcuteNurseScreen> {
