...
class NcdCenterAssessmentScreen extends CupertinoPageRoute {

  EncounterDetailsState encounterDetailsState;
  NcdCenterAssessmentScreen({this.encounterDetailsState})
      : super(builder: (BuildContext context) => new NcdCenterAssessment(encounterDetailsState: encounterDetailsState));

}

class NcdCenterAssessment extends StatefulWidget {
  EncounterDetailsState encounterDetailsState;
  NcdCenterAssessment({this.encounterDetailsState});
  @override
  _NcdCenterAssessmentState createState() => _NcdCenterAssessmentState();
}

class _NcdCenterAssessmentState extends State<NcdCenterAssessment> {
