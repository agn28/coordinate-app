...
class EditIncompleteEncounterScreen extends StatefulWidget {
  ...
  @override
  _EditIncompleteEncounterScreenScreenState createState() =>
      _EditIncompleteEncounterScreenScreenState();
}

class _EditIncompleteEncounterScreenScreenState
    extends State<EditIncompleteEncounterScreen> {
  int _currentStep = 0;
  ...
  getIncompleteAssessment() async {
    ...
    var data = await AssessmentController()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            AppLocalizations.of(context).translate('editIncompleteEncounter')),
      ),
      body: !isLoading
          ? GestureDetector(
              onTap: () {
