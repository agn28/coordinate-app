...
class FollowupAcuteScreen extends StatefulWidget {
  static const path = '/followupAcuteScreen';
  FollowupAcuteScreen({this.parent});
  final parent;

  @override
  _FollowupAcuteScreenState createState() => _FollowupAcuteScreenState();
}
...
class _FollowupAcuteScreenState extends State<FollowupAcuteScreen> {
