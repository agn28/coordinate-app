...
var _questions = {
  'tobacco': {
    'items': [
      {
        'question':
            'Have you used tobacco (all forms – cigarettes, biri, chewing tobacco, zarda, gul) during the past 12 months?',
        'question_bn':
            'আপনি কি গত ১২ মাসে তামাক (সমস্ত ধরণের - সিগারেট, বিড়ি, তামাকপাতা, জর্দা, গুল) ব্যবহার করেছেন?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
        'question':
            'Were you regularly exposed to secondhand tobacco smoke in the past 12 months?',
        'question_bn':
            'আপনি কি গত ১২ মাসে নিয়মিতভাবে তামাকের ধোঁয়ার সংস্পর্শে এসেছিলেন?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
    ]
  ...
  'diet': {
    'items': [
      {
        'question':
            'Do you eat at least 5 portions of fruit and vegetables (excluding starchy vegetables) daily? (1 serving = 0.5 cup cooked vegetables or 1 cup raw vegetables; 1 orange, apple, banana, mango)',
        'question_bn':
            'আপনি কি প্রতিদিন কমপক্ষে ৫ ভাগ ফলমূল এবং শাকসব্জি (স্টার্চযুক্ত সবজি বাদে) খান? (১পরিবেশন = ০.৫ কাপ রান্না করা শাকসব্জী বা ১ কাপ কাঁচা শাকসব্জী; ১ কমলা, আপেল, কলা, আমের)',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
        'question':
            'Do you eat red meat, fried foods, canned or other processed foods on most days?',
        'question_bn':
            'আপনি কি বেশিরভাগ দিন লাল মাংস, ভাজা খাবার, টিনজাত বা অন্যান্য প্রক্রিয়াজাত খাবার খান?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
        'question':
            'Do you have sugary drinks (for example, soda, juice, sweetened milk) on most days?',
        'question_bn':
            'আপনার কি বেশিরভাগ দিন মিষ্টি পানীয় (যেমন - সোডা, জুস, মিষ্টি দুধ) পান করেন?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
  ...
  'physical_activity': {
    'items': [
      {
        'question':
            'Do you do physical activity of moderate intensity i.e. you get a little bit out of breath, for at least 30 minutes per day on 5 days per week, or for 150 minutes per week?',
        'question_bn':
            'আপনি কি প্রতি সপ্তাহে ৫ দিন প্রতিদিন কমপক্ষে ৩০ মিনিট, বা প্রতি সপ্তাহে ১৫০ মিনিট তীব্র মাত্রার শারীরিক পরিশ্রম করেন যেখানে শ্বাসপ্রশ্বাস দ্রুত হয়?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
        ...
        'question_bn':
            'আপনি কি প্রতিদিন ৫ ঘন্টার বেশি সময় বসে কাটান বা বসে বসে কাজ করেন?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
    ]
  ...
  'current_medication': {
    'items': [
      {
        'question':
            'What medications are you taking (including over-the-counter /herbal /traditional remedies/recreational)?',
        'question_bn':
            'আপনি কী কী ওষুধ খাচ্ছেন (ফার্মেসী থেকে কেনা / ভেষজ / প্রচলিত ওষুধ / বিনোদনমূলক)?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
        ...
        'question_bn':
            'আপনি কি ওষুধগুলি প্রেসক্রিপশনে দেয়া নিয়ম অনুযায়ী খাচ্ছেন?',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
  ...
  'medical_history': {
    'items': [
      {
        'question':
            'Heart attack/angina/other heart diseases (e.g. heart failure, rheumatic heart disease)',
        'question_bn':
            'হার্ট অ্যাটাক / এনযাইনা / অন্যান্য হৃদরোগ (যেমনঃ হার্ট ফেইলিউর, রিউম্যাটিক হার্ট ডিজিজ)',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
      ...
      {
        'question':
            'Other illnesses such as tuberculosis, HIV (confirm HIV status, testing as per national guidelines)',
        'question_bn':
            'অন্যান্য অসুস্থতা যেমন- যক্ষ্মা, এইচআইভি  (এইচআইভি আছে কিনা নিশ্চিত হন, জাতীয় নির্দেশিকা অনুযায়ী পরীক্ষা করা হয়েছে কিনা)',
        'options': ['yes', 'no'],
        'options_bn': ['হ্যা', 'না']
      },
      {
  ...
  'new_patient': {
    'medical_history': {
      'items': [
        ...
        },
        {
          ...
          'question_bn':
              'আপনার কি কখনও হাঁপানি / সিওপিডি (ফুস্ফুসের দীর্ঘমেয়াদী শ্বাসকষ্টজনিত রোগ ধরা পড়েছে?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'key': 'asthma'
        },
      ...
      'items': [
        {
          ...
          'question_bn':
              'আপনি ব্লাড-প্রেসার বা উচ্চ রক্তচাপের জন্য কোনও ওষুধ খাচ্ছেন?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'type': 'blood_pressure',
        ...
        },
        {
          ...
          'question_bn':
              'আপনি কি কোনও অ্যাসপিরিন / ক্লপিডগ্রেল জাতীয় ওষুধ খাচ্ছেন?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'type': 'heart',
        ...
        {
          'question':
              'Are you taking any drug for lowering fat in blood (Cholesterol)?',
          'question_bn':
              'রক্তে ফ্যাট (কোলেস্টেরল) কমাতে আপনি কি কোনও ওষুধ খাচ্ছেন?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
    ...
    'risk_factors': {
      'items': [
        ...
        {
          'question':
              'Do you currently consume any smokeless tobacco such as sada pata, jarda, gul, khaini etc?*',
          'question_bn':
              'আপনি বর্তমানে কোনও ধোঁয়াবিহীন তামাক (যেমন সাদ পাতা, জর্দা, গুল, খাইনি ইত্যাদি) সেবন করেন?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'group': 'tobacco',
        ...
        {
          'question':
              'Do you eat atleast 5 portions of fruits and vegetables daily?',
        ...
        // },
        {
          ...
          'question_bn':
              'আপনি কি আপনার খাবারে অতিরিক্ত লবণ যুক্ত করেন বা বেশিরভাগ দিন অতিরিক্ত লবণ বা নোনতা খাবার খান?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'key': 'extra_salt'
        },
        {
          'question':
              'Do you frequently eat salty foods such as sauce, achar, singara, samucha, etc?',
          'question_bn':
              'আপনি কি নিয়মিত লবনাক্ত খাবার খান, যেমনঃ সস, আচার, সিঙ্গারা, সমুচা?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'group': 'unhealth-diet',
          'type': 'salt',
        ...
        {
          'question':
              'Do you frequently eat processed food such as chips, chanachur, biscuit, noodles etc?',
          'question_bn':
              'আপনি কি নিয়মিত প্রক্রিয়াজাত খাবার খান (যেমন চিপস, চানাচুর, বিস্কুট ইত্যাদি?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'group': 'unhealth-diet',
          'type': 'processed-food',
        ...
        {
          'question':
              'Do you do physical activity of moderate intensity (you get a little bit out of breath) for atleast 30 minutes per day on 5 days per week or 150 minutes per week?',
          'question_bn':
              'আপনি কি প্রতি সপ্তাহে ৫ দিন প্রতিদিন কমপক্ষে ৩০ মিনিট, বা প্রতি সপ্তাহে ১৫০ মিনিট মাঝারি থেকে তীব্র মাত্রার শারীরিক পরিশ্রম করেন যেখানে শ্বাসপ্রশ্বাস দ্রুত হয়?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
        ...
        {
          'question':
              'Do you do physical activity of high intensity (you get out of breath) for at least 15 minutes per day on 5 days per week, or 75 minutes per week?',
          'question_bn':
              'আপনি কি প্রতি সপ্তাহে ৫ দিন প্রতিদিন কমপক্ষে ১৫ মিনিট, বা প্রতি সপ্তাহে ৭৫ মিনিট তীব্র মাত্রার শারীরিক পরিশ্রম করেন যেখানে শ্বাসপ্রশ্বাস দ্রুত হয়?',
          'options': ['yes', 'no'],
          'options_bn': ['হ্যা', 'না'],
          'group': 'physical-activity',
...
class Questionnaire {
  ...
  addTobacco(type, answers) {
    ...
    for (var qn in _questionnaireItems) {
      if (qn['body']['data']['type'] == type) {
        _questionnaireItems[_questionnaireItems.indexOf(qn)] =
  ...
  addPhysicalActivity(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_preparePhysicalActivityData(questions, answers, type));
    }
  ...
  addMedicalHistory(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareMedicalHistoryData(questions, answers, type));
    }
  ...
  addCurrentMedication(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareCurrentMedicationData(questions, answers, type));
    }
  ...
  addVideoSurvey(url, careplan) {
    ...
    print(_questionnaireItems
        .where((item) => item['body']['data']['url'] == url)
        .isEmpty);
    if (_questionnaireItems
        .where((item) => item['body']['data']['url'] == url)
        .isEmpty) {
  ...
  addAlcohol(type, answers) {
    ...
    for (var qn in _questionnaireItems) {
      if (qn['body']['data']['type'] == type) {
        answers.length == 1
            ...
            : _questionnaireItems[_questionnaireItems.indexOf(qn)] =
                _alcoholItems = _prepareAlcoholData(questions, answers, type);
        updated = true;
      }
    }
    ...
    if (!updated) {
      answers.length == 1
          ? _questionnaireItems
              .add(_prepareNonAlcoholData(questions, answers, type))
          : _questionnaireItems
              .add(_prepareAlcoholData(questions, answers, type));
    }
  ...
  addNewMedicalHistoryNcd(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareNewMedicalDataNcd(questions, answers, type));
    }
  ...
  addNewMedication(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareNewMedicationData(questions, answers, type));
    }
  ...
  addNewMedicationNcd(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareNewMedicationDataNcd(questions, answers, type));
    }
  ...
  addNewCounselling(type, answers) {
    ...
    if (!updated) {
      _questionnaireItems
          .add(_prepareNewCounsellingData(questions, answers, type));
    }
